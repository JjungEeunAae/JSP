...
<div id="id01" class="modal">
  ...
  <form class="modal-content" action="signon.do" enctype="multipart/form-data" method="post">
    <div class="container">
      ...
      <input type="password" placeholder="member_pw" name="member_pw" required>
      
      <label for="member_name"><b>Name</b></label>
      <input type="password" placeholder="member_name" name="member_name" required>
      
      <label for="member_phone"><b>연락처</b></label>
      <input type="password" placeholder="member_phone" name="member_phone" required>
