...
<div id="container">
  ...
  <div id="loginBox">
    ...
    <!-- 로그인 페이지 타이틀 -->
    <div id="loginBoxTitle">User Login</div>
    <!-- 아이디, 비번, 버튼 박스 -->
    <form action="login.do" method="post">
	    <div id="inputBox">
	      ...
	      <div class="button-login-box" >
	        ...
	        <div>
		        <button class="w-btn w-btn-gra3 w-btn-gra-anim btn-xs" style="width:100%" type="submit">
		        	Login
		    	</button>
		    	<input type="reset" class="w-btn w-btn-gra3 w-btn-gra-anim btn-xs" style="width:100%" value="취소">
	    	</div>
	      </div>
	    </div>
    </form>
